...
/**
 * A floating feedback button on every page of the landing site. There is no single
 * tool here, so this is app-level feedback about UtilFoundry as a whole — posted to
 * the shared admin service (apps/admin), a different origin from this site.
 */
          ...
          <form onSubmit={handleSubmit}>
            <div className="feedback-dialog-head">
              <div>
                ...
                <p>Help us improve UtilFoundry. Your feedback makes a difference!</p>
              </div>
