...
export function BrandMark({ size = 29 }: BrandMarkProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" role="img" aria-label="UtilFoundry mark" xmlns="http://www.w3.org/2000/svg">
      <rect width="64" height="64" rx="18" fill="#111827" />
      <path d="M18 17V33C18 42.5 23.6 48 32 48C40.4 48 46 42.5 46 33V17" stroke="#F4B183" strokeWidth="5" strokeLinecap="round" />
