...
export const TOOLS: ToolDefinition[] = [
  ...
  { id: "diff", slug: "text-diff", name: "Text Diff", tagline: "Compare two text snippets", description: "Compare two snippets separated by a --- line and see which lines were added or removed.", category: "Text", accent: "lime", inputLabel: "Two snippets" },
  ...
  { id: "jsonpath", slug: "jsonpath-extractor", name: "JSONPath Extractor", tagline: "Extract nested values with JSONPath", description: "Pull values out of a JSON document with a JSONPath expression instead of reading it by hand.", category: "JSON", accent: "cyan", inputLabel: "JSON" },
  { id: "json-diff", slug: "json-diff", name: "JSON Diff", tagline: "Compare two JSON documents", description: "Compare two JSON documents separated by a --- line and list the fields that were added, removed or changed.", category: "JSON", accent: "indigo", inputLabel: "Two JSON documents" },
