...
export const TOOLS: ToolDefinition[] = [
  { id: "json", slug: "json-formatter", name: "JSON Formatter", tagline: "Format, validate and minify JSON", description: "Format, validate and minify JSON in your browser, with the parse error shown in plain words when the document is broken.", category: "Format & validate", accent: "violet", inputLabel: "JSON" },
  ...
  { id: "hash", slug: "hash-generator", name: "Hash Generator", tagline: "Create SHA-256 and SHA-1 hashes", description: "Produce a SHA-256 or SHA-1 digest of any text using the browser's Web Crypto implementation.", category: "Security", accent: "rose", inputLabel: "Text" },
  ...
  { id: "diff", slug: "text-diff", name: "Text Diff", tagline: "Compare two text snippets", description: "Compare two snippets separated by a --- line and see which lines were added or removed.", category: "Text", accent: "lime", inputLabel: "Two snippets", inputHint: "Paste both snippets in the one box, separated by a line containing only ---" },
  ...
  { id: "json-diff", slug: "json-diff", name: "JSON Diff", tagline: "Compare two JSON documents", description: "Compare two JSON documents separated by a --- line and list the fields that were added, removed or changed.", category: "JSON", accent: "indigo", inputLabel: "Two JSON documents", inputHint: "Both documents in the one box, separated by a line containing only ---" },
  ...
  { id: "yaml-formatter", slug: "yaml-formatter", name: "YAML Formatter", tagline: "Normalize YAML configuration", description: "Re-emit a YAML document with consistent indentation and key order preserved.", category: "Format & validate", accent: "teal", inputLabel: "YAML" },
  ...
  { id: "json-schema", slug: "json-schema-validator", name: "JSON Schema Validator", tagline: "Validate JSON against a schema", description: "Validate a JSON document against a JSON Schema, with each failure reported by the path that broke it.", category: "Format & validate", accent: "violet", inputLabel: "Data and schema", inputHint: "The data first, then a line containing only ---, then the JSON Schema it must satisfy. A schema is itself JSON: {\"type\":\"object\",\"required\":[\"name\"]}." },
  ...
  { id: "gitignore", slug: "gitignore-generator", name: ".gitignore Generator", tagline: "Generate starter ignore rules", description: "Build a .gitignore from a list of stacks, such as Node, Python or macOS.", category: "Code", accent: "slate", inputLabel: "Stacks" },
  ...
  { id: "env", slug: "env-formatter", name: "Environment Formatter", tagline: "Normalize and sort env variables", description: "Sort and tidy a .env file, keeping comments and reporting duplicate keys.", category: "Code", accent: "teal", inputLabel: "Env file" },
  { id: "openapi-diff", slug: "openapi-diff", name: "OpenAPI Diff", tagline: "Detect potentially breaking API changes", description: "Compare two OpenAPI documents and flag removed paths, methods and responses that may break clients.", category: "API", accent: "pink", inputLabel: "Two documents", inputHint: "The old document first, then a line containing only ---, then the new one" },
  ...
  { id: "jwt-rsa", slug: "jwt-rs256-verifier", name: "JWT RS256 Verifier", tagline: "Verify JWTs with a local JWK", description: "Verify an RS256 token against a JWK you paste, using Web Crypto in this tab.", category: "Security", accent: "amber", inputLabel: "Token and JWK", inputHint: "The token first, then a line containing only ---, then the JWK public key that should verify it" },
