 ...
 * (apps/admin) — a different origin, so this never touches whatever image the tool
 * itself is working on. The current tool's name is looked up from the same TOOLS
 * registry the page itself uses, via the URL, and is only sent when "include tool
 * details" stays checked.
 */
